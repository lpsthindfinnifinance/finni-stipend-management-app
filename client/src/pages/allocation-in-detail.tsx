...
export default function AllocationInDetail() {
  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold" data-testid="text-page-title">
              Incoming Allocation #{allocation.id}
            </h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Sender Practices</CardTitle>
          </CardHeader>
              ...
              <TableBody>
                {allocation.donorPractices && allocation.donorPractices.length > 0 ? (
                  allocation.donorPractices.map((practice: any) => (
                    <TableRow key={practice.id} data-testid={`row-sender-practice-${practice.id}`}>
